...
if [[ "${SYSTEMD_MODE}" == "system" ]]; then
  ...
  echo "  bash: BOT_SETUP_MODE=1 ${INSTALL_DIR}/.venv/bin/python ${INSTALL_DIR}/bot/bot.py"
  echo "  fish: env BOT_SETUP_MODE=1 ${INSTALL_DIR}/.venv/bin/python ${INSTALL_DIR}/bot/bot.py"
  echo "  zsh: BOT_SETUP_MODE=1 ${INSTALL_DIR}/.venv/bin/python ${INSTALL_DIR}/bot/bot.py"
  echo ""
